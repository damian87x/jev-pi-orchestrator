---
name: jevo-worker-fast
description: "Fast-tier conductor-max slice worker for mechanical slices (rename, config, small function, tests for existing behaviour). Use when jevo triage returns tier=fast."
